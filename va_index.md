...
Vulnerability Advisor checks the configuration settings for the following types of apps:
-   MySQL
-   NGINX
-   Apache
...
Before you deploy an image, you can review its Vulnerability Advisor report to view details about any vulnerable packages and nonsecure app settings.
{:shortdesc}
...
1.  List all images in your {{site.data.keyword.Bluemix_notm}} account. A list of all images are returned, independent of the namespace where they are stored.
