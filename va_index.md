...
4.  To view the details for the status, review the Vulnerability Advisor report.
    ...
    In the CLI output, you can view a list of vulnerable packages, a description of the vulnerability that was found, and, if a link is provided, a link to instructions for how to fix the vulnerability.
